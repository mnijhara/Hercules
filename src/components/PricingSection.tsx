      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-10">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold text-slate-900 tracking-tight leading-tight mb-4">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-600 to-blue-600">AI-powered execution.</span>
          </h2>

          <p className="text-base sm:text-lg text-slate-600 font-normal leading-relaxed mb-8">
            Every Hercules plan combines Fractional CHRO leadership with an always-on AI HR workforce. Choose the level of support that fits your team today, then scale as you grow.
          </p>
          ...
          <div className="inline-flex items-center p-1.5 rounded-full bg-slate-200/80 border border-slate-300">
            ...
            >
              ...
              <span className="text-[10px] bg-sky-100 text-sky-800 px-2 py-0.5 rounded-full font-mono font-bold border border-sky-200">Save 20%</span>
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
          {PRICING_PLANS.map((plan) => {
            ...
            return (
              <div
                key={plan.id}
                className={`rounded-3xl p-8 flex flex-col justify-between transition-all duration-300 relative ${plan.highlighted ? 'bg-white border-2 border-sky-600 shadow-xl shadow-sky-500/10 -translate-y-2' : 'bg-white border border-slate-200/90 shadow-sm hover:border-slate-300'}`}
              >
                {plan.highlighted && (
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600 font-normal mb-6 min-h-[36px]">{plan.tagline}</p>
                  ...
                  <div className="space-y-3 mb-8">
                    <span className="text-[10px] uppercase tracking-wider text-sky-800 font-bold font-mono block">What you get</span>
