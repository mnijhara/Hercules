...
import { ArrowRight, MessageSquare, Sparkles, CheckCircle2, ShieldCheck, Play } from 'lucide-react';
...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section id="how-it-works" className="relative pt-20 sm:pt-28 pb-12 sm:pb-16 overflow-hidden bg-white border-b border-slate-200">
      {/* Background Subtle Tech Grid & Ambient Subtle Glow */}
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
          <button
            ...
            className="w-full sm:w-auto px-8 py-4 rounded-full bg-slate-900 hover:bg-slate-800 text-white font-bold text-sm transition-all duration-200 shadow-xl shadow-slate-900/15 hover:shadow-slate-900/25 flex items-center justify-center gap-2 group hover:scale-[1.02] active:scale-[0.98]"
            id="hero-watch-works-btn"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto px-7 py-4 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-900 border border-slate-300 font-semibold text-sm transition-all duration-200 flex items-center justify-center gap-2.5 shadow-sm"
          >
            <div className="w-4 h-4 flex items-center justify-center text-sky-600">
              <MessageSquare className="w-4 h-4" />
            </div>
            <span>Deploy Hercules AI (Slack, WhatsApp, GMeet)</span>
          </button>
        </div>
        ...
        <div className="pt-6 border-t border-slate-200/80 grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-3xl mx-auto">
          <div>
            <div className="text-2xl font-black text-slate-900">16+ hrs</div>
            <div className="text-xs text-slate-500 uppercase tracking-wider font-semibold mt-0.5">Saved per week</div>
          </div>
          <div>
            <div className="text-2xl font-black text-sky-600">24/7</div>
            <div className="text-xs text-slate-500 uppercase tracking-wider font-semibold mt-0.5">Proactive Monitoring</div>
          </div>
          <div>
            <div className="text-2xl font-black text-slate-900">30 sec</div>
            <div className="text-xs text-slate-500 uppercase tracking-wider font-semibold mt-0.5">CTC Offer Generation</div>
          </div>
          <div>
            <div className="text-2xl font-black text-emerald-600">100%</div>
            <div className="text-xs text-slate-500 uppercase tracking-wider font-semibold mt-0.5">DRDA & POSH Compliant</div>
          </div>
        </div>
      </div>
    </section>
