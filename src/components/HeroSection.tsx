    ...
    <section id="how-it-works" className="relative pt-20 sm:pt-28 pb-12 sm:pb-16 overflow-hidden bg-white border-b border-slate-200">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <p className="text-base sm:text-xl text-slate-600 max-w-2xl mx-auto font-normal leading-relaxed mb-8">
          Get a senior Fractional CHRO as your strategic HR partner — backed by an AI HR workforce that handles the everyday work 24/7 across Slack, WhatsApp, Google Meet and Email.
        </p>
        ...
        <div className="pt-6 border-t border-slate-200/80 grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-3xl mx-auto">
          <div>
            ...
            <div className="text-xs text-slate-500 uppercase tracking-wider font-semibold mt-0.5">Founder time saved</div>
          </div>
          <div>
            <div className="text-2xl font-black text-sky-600">24/7</div>
            <div className="text-xs text-slate-500 uppercase tracking-wider font-semibold mt-0.5">AI HR execution</div>
          </div>
          <div>
            <div className="text-2xl font-black text-slate-900">30 sec</div>
            <div className="text-xs text-slate-500 uppercase tracking-wider font-semibold mt-0.5">Offer generation</div>
          </div>
          <div>
            <div className="text-2xl font-black text-emerald-600">1 team</div>
